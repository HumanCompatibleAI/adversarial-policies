...
# Check PPO Baselines learns on some simple (single-agent!) Gym environments
...
OUT_DIR=data/single_agent

call_parallel "$*" ${OUT_DIR}/parallel modelfree.ppo_baseline with \
