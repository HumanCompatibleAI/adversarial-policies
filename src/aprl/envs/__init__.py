...
register(
    ...
    kwargs={
        ...
        "scene_xml_path": resource_filename(
            "gym_compete", "new_envs/assets/world_body_arena.humanoid_body.humanoid_body.xml"
        ),
...
register(
    ...
    kwargs={
        ...
        "scene_xml_path": resource_filename(
            "gym_compete", "new_envs/assets/world_body_arena.ant_body.ant_body.xml"
        ),
        "world_xml_path": resource_filename("gym_compete", "new_envs/assets/world_body_arena.xml"),
