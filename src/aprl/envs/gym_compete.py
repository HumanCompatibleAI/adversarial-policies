...
class TransparentLSTMPolicy(transparent.TransparentPolicy, policy.LSTMPolicy):
    ...
    def __init__(self, sess, ob_space, ac_space, n_env, n_steps, n_batch, transparent_params,
        ...
        policy.LSTMPolicy.__init__(self, sess, ob_space, ac_space, n_env, n_steps, n_batch,
                                   hiddens, scope, reuse, normalize)
...
class TransparentMLPPolicyValue(transparent.TransparentPolicy, policy.MlpPolicyValue):
    ...
    def __init__(self, sess, ob_space, ac_space, n_env, n_steps, n_batch, transparent_params,
                 hiddens=None, scope="input", reuse=False, normalize=False):
        policy.MlpPolicyValue.__init__(self, sess, ob_space, ac_space, n_env, n_steps, n_batch,
                                       hiddens=hiddens, scope=scope, reuse=reuse,
                                       normalize=normalize)
        transparent.TransparentPolicy.__init__(self, transparent_params)
